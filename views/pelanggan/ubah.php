				...
				<div class="row">
					<div class="col-sm-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pelanggan/proses_ubah/' . $pelanggan->id) ?>" enctype="multipart/form-data">
								  	<div class="form-group">
								  		<label for="nama">Nama pelanggan</label>
								  		<input type="text" value="<?= $pelanggan->nama ?>" name="nama" id="nama" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
									...
									<div class="form-group">
								  		...
								  		<textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="ketik"><?= $pelanggan->alamat ?></textarea>
								  	</div>
