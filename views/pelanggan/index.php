            ...
            <div class="navbar-vertical navbar nav-dashboard">
                <div class="h-100" data-simplebar>
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="<?= base_url('template') ?>/assets/images/brand/logo/logo-2.svg"
									...
									<div class="table-responsive table-card">
										<table class="table text-nowrap mb-0  table-centered table-hover" id="mytable">
											...
											<tbody>
												...
												<?php while ($pelanggan = $data_pelanggan->fetch_object()) : ?>
													<tr>
													...
													<!-- Modal -->
													<div class="modal fade" id="exampleModalEdit-<?= $pelanggan->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered" role="document">
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<form action="<?= base_url('pelanggan/proses_ubah/' . $pelanggan->id) ?>" method="POST" enctype="multipart/form-data">
																		

																		<div class="mb-3">
																			<label for="harga" class="form-label">Harga</label>
																			<div class="input-group">
																				<input type="number" value="<?= $pelanggan->harga ?>" name="harga" id="harga" required="required" autocomplete="off" class="form-control">
																		...
																		<div class="mb-3">
																			...
																			<select name="status" id="status" class="form-select">
																				<option value="0" <?= ($pelanggan->status == 0) ? 'selected' : '' ?>>Tersedia</option>
																				<option value="1" <?= ($pelanggan->status == 1) ? 'selected' : '' ?>>Sedang Dipinjam</option>
																				<option value="2" <?= ($pelanggan->status == 2) ? 'selected' : '' ?>>Dikembalikan</option>
																				<option value="3" <?= ($pelanggan->status == 3) ? 'selected' : '' ?>>Tidak Tersedia</option>
																			</select>
								...
								<div>
									...
									<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data pelanggan</h5>
													<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
													</button>
												</div>
												<div class="modal-body">
